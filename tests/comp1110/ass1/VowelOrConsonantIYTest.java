...
public class VowelOrConsonantIYTest extends TranscriptionTest {
    ...
    public static final String[] INPUT_I_ELSEWHERE = new String[]{"ski", "qui", "mis", "paris", "disparu", "disputé"};
    public static final String[] EXPECTED_I_ELSEWHERE = new String[]{"ski", "ki", "mi", "pa.ʁi", "dis.pa.ʁy", "dis.py.te"};
    ...
    public static final String[] INPUT_Y_ELSEWHERE = new String[]{"y", "cyclorandonneur", "éthyl", "stylé", "cybercriminalité"};
    public static final String[] EXPECTED_Y_ELSEWHERE = new String[]{"i", "si.klɔ.ʁɑ̃.dɔ.nœʁ", "e.til", "sti.le", "si.bɛʁ.kʁi.mi.na.li.te"};
